...
<head>
    ...
    <title>{{ $portfolios->title }} - Portfolio Dashboard</title>
    ...
    <link id="sleek-css" rel="stylesheet" href="{{ asset('backend/assets/css/all.min.css') }}" />



    <!-- FAVICON -->
    <link href="{{ asset($icon->shortCut) }}" rel="shortcut icon" type="image/x-icon">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-colorpicker/3.2.0/js/bootstrap-colorpicker.min.js" integrity="sha512-INXxqXxcP6zawSei7i47Xmu+6ZIBRbsYN1LHAy5H1gzl1XIfTbI/OLjUcvBnDD8F3ZSVB6mf8asEPTMxz4VNjw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
